  ...
  return (
    <section className="relative min-h-screen bg-black dark:bg-white overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
      ...
      <div className="min-h-screen flex items-center justify-center py-8 sm:py-12 md:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-24 items-center">
          {/* Left side - Content */}
          <motion.div
        ...
        <motion.div
          className="relative mt-6 sm:mt-8 lg:mt-0 flex justify-center lg:justify-start"
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          ...
          <div className="relative flex items-center justify-center space-x-2 sm:space-x-4 md:space-x-6">
            ...
            <motion.div
              className="relative z-10 w-32 sm:w-40 md:w-48 lg:w-56 xl:w-64 h-[256px] sm:h-[320px] md:h-[400px] lg:h-[450px] xl:h-[500px] rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden shadow-2xl"
            ...
            <motion.div
              className="relative w-28 sm:w-36 md:w-44 lg:w-52 xl:w-60 h-[224px] sm:h-[288px] md:h-[352px] lg:h-[396px] xl:h-[440px] rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden shadow-xl"
